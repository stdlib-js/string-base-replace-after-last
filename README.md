...
```javascript
import replaceAfterLast from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-replace-after-last@v0.1.2-deno/mod.js';
```
...
[@stdlib/string/base/replace-after]: https://github.com/stdlib-js/string-base-replace-after/tree/deno
